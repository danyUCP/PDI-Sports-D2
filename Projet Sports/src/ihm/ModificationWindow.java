...
public class ModificationWindow extends JFrame {
			 ...
			 */
				...
				private ModificationPanel contentPane;
				...
				public ModificationWindow(){
					...
					contentPane = new ModificationPanel();
				...
				public static void main(String[] args) {
					ModificationWindow frame = new ModificationWindow();
