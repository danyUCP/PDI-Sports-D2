...
public class ClimbingGraphPanel extends JPanel {
	...
	public  ClimbingGraphPanel(User user) {
		this.user = user;
	...
	{	
		...
		graphPanel.add(new ClimbingSummaryBar(wm.getWorkoutList(2)), BorderLayout.CENTER);
	}
	...
	{	
		...
		String[] choices = {"Mon résumé", "Difficulté"};
		...
		{			
			...
			if(e.getSource() == displayButton)
			{
				...
				if(choiceBox.getSelectedIndex() == 0)
					...
					graphPanel.add(new ClimbingWorkoutPie(wm.getWorkoutList(2)), BorderLayout.CENTER);
