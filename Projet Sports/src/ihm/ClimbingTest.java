...
public class ClimbingTest extends JPanel {
	...
	public ClimbingTest() {
		...
		btn_submit2.addActionListener(new Action_Alter());
		...
		public void actionPerformed(ActionEvent e4) {
			...
			if (e4.getSource()==comboBox_date) {
				...
				while (iterator.hasNext()) {
					...
					remove(lblNewLabel_difficulty);
			    	repaint();
				    lblNewLabel_difficulty = new JLabel(""+i+"");
					lblNewLabel_difficulty.setBounds(154, 220, 86, 24);
				...
				while (iterator1.hasNext()) {
					...
					remove(lblNewLabel_duree);
					repaint();
					lblNewLabel_duree = new JLabel(""+j+"");
					lblNewLabel_duree.setBounds(154,285 , 86, 24);
			...
			if (e4.getSource()==btn_submit2) {  
				...
				//try {
					...
					Query preparedStatement = session.createQuery(" UPDATE ClimbingWorkout climbingworkout set duration="+int_final_times+", course_difficulty='"+final_difficulty+"' where date=str_to_date('"+result_date+"','%Y/%m/%d')");
	...
	public class Action_Selection implements ActionListener{
		...
		public void actionPerformed(ActionEvent e2) {
			...
			if (choix_modif == "Add") {
			    ...
			    remove(lblNewLabel_difficulty);
			    repaint();
			//	lblNewLabel_duree.setText("Duration (min)");
			//	lblNewLabel_duree.setBounds(154,285 , 86, 24);
				add(lblNewLabel_duree);
			//	lblNewLabel_difficulty.setText("Difficulty");
			//	lblNewLabel_difficulty.setBounds(154, 220, 86, 24);
				add(lblNewLabel_difficulty);
			...
			if (choix_modif == "Alter"){
			  ...
			  j++; 
					...
					remove(lblNewLabel_date);
					remove(lblNewLabel_date_2);
